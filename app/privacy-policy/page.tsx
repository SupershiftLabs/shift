...
export const metadata = {
  title: 'Privacy Policy | SuperShift Labs',
  description: 'Privacy Policy for SuperShift Labs - Learn how we collect, use, and protect your personal information.',
};
        ...
        <div className="space-y-8 text-gray-300">
          <section>
            ...
            <p className="leading-relaxed">
              SuperShift Labs ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website <a href="https://supershiftlabs.com" className="text-green-400 hover:underline">supershiftlabs.com</a> and use our services.
            </p>
          ...
          <section>
            ...
            <p className="leading-relaxed mb-3">When you visit our website, we may automatically collect certain information, including:</p>
            <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-green-400 mb-4">3. How We Use Your Information</h2>
            <p className="leading-relaxed mb-3">We use the information we collect for various purposes, including to:</p>
            <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-green-400 mb-4">4. How We Share Your Information</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-green-400 mb-4">5. Your Privacy Rights</h2>
            
            <h3 className="text-xl font-semibold text-white mt-6 mb-3">5.1 California Residents (CCPA)</h3>
            ...
            <h3 className="text-xl font-semibold text-white mt-6 mb-3">5.2 General Rights</h3>
            <p className="leading-relaxed mb-3">All users have the right to:</p>
            <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-green-400 mb-4">9. Third-Party Links</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-green-400 mb-4">10. International Data Transfers</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-green-400 mb-4">11. Do Not Track Signals</h2>
            <p className="leading-relaxed">
              Some web browsers have a "Do Not Track" feature that lets you tell websites you do not want to have your online activities tracked. We currently do not respond to Do Not Track signals.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-green-400 mb-4">12. Changes to This Privacy Policy</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-green-400 mb-4">13. Contact Us</h2>
